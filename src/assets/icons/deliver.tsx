export const DeliverIcon = (color: string) => {
  return (
    <svg width="41" height="40" viewBox="0 0 41 40" color={color} fill="none" xmlns="http://www.w3.org/2000/svg">
      <g clipPath="url(#clip0_1593_313)">
        <path
